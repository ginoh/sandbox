...
import (
	...
	samplecontrollerv1beta1 "github.com/ginoh/foo-controller/api/v1beta1"
	"github.com/ginoh/foo-controller/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		SyncPeriod:             &resyncPeriod, // Defaults to 10 hours
		Scheme:                 scheme,
		MetricsBindAddress:     metricsAddr,
		Port:                   9443,
		HealthProbeBindAddress: probeAddr,
		LeaderElection:         enableLeaderElection,
		LeaderElectionID:       "6096a297.ginoh.github.io",
	})
	if err != nil {
